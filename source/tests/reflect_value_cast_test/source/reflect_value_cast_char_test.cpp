...
class reflect_value_cast_char_test : public testing::Test
{
  public:
};

TEST_F(reflect_value_cast_char_test, char_to_bool_cast)
{
...
TEST_F(reflect_value_cast_char_test, char_to_char_cast)
{
	value v = value_create_char('C');
...
TEST_F(reflect_value_cast_char_test, char_to_short_cast)
{
	value v = value_create_char('C');
...
TEST_F(reflect_value_cast_char_test, char_to_int_cast)
{
	value v = value_create_char('C');
...
TEST_F(reflect_value_cast_char_test, char_to_long_cast)
{
	value v = value_create_char('C');
...
TEST_F(reflect_value_cast_char_test, char_to_float_cast)
{
	value v = value_create_char('C');
...
TEST_F(reflect_value_cast_char_test, char_to_double_cast)
{
	value v = value_create_char('C');
